...
#
# pg.mixer.music.load('Космические коты - музыка.wav')
# pg.mixer.music.set_volume(0.5)
# pg.mixer.music.play()
#
# laser_sound = pg.mixer.Sound('Космические коты - звук лазера.wav')
# win_sound = pg.mixer.Sound('Космические коты - звук победы.wav')
#
